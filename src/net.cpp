...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "PostCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    	{"136.243.65.148","136.243.65.148"},
	{"95.216.136.246","95.216.136.246"},
	{"213.239.207.170","213.239.207.170"}
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("PostCoin-dnsseed");
...
unsigned int pnSeed[] =
{
    0x904c478d, 0x94fb5a22, 0xa2f41dbe, 0x33ff3b66, 0x968c9fe2,
    0x4d58d00c, 0x56051c09, 0xb025174a, 0x52e9ffc8, 0x47cbfcce,
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. PostCoin is probably already running."), addrBind.ToString().c_str());
        else
