...
unsigned int nStakeMaxAge = 14 * 24 * 60 * 60;
...
const string strMessageMagic = "PostCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	{ 
		nSubsidy = 30000000 * COIN; return nSubsidy; 
	}
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PostCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "PostCoin errupted on - 3-17-16";
        CTransaction txNew;
        txNew.nTime = 1458250528;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
		...
		uint256 nhashMerkleRoot = uint256("8aff865e0c0cc8278e61b78999544902fc7cebb603a291457141d5eb2c63d5aa");
...
unsigned char pchMessageStart[4] = { 0x35, 0xc3, 0xd6, 0xa2 };
